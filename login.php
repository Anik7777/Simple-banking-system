...
$mysqli = mysqli_connect($databaseHost, $databaseUsername, $databasePassword, $databaseName); 
            ...
            $Login=mysqli_query($mysqli,"SELECT * FROM `user` WHERE username='$user' and password='$pass'");
            $count1=mysqli_num_rows($Login);
            $Amt1=mysqli_query( 
                $mysqli,"SELECT intbalans,id FROM user where username='$user' and password='$pass'");
