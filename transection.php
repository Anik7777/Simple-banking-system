...
$mysqli = mysqli_connect($databaseHost, $databaseUsername, $databasePassword, $databaseName); 
            $id=$_SESSION['user1'];
        $_SESSION['user']=mysqli_query($mysqli,"SELECT ((((SELECT intbalans FROM user WHERE id ='$id') + 
...
//WHERE id='$id'");
            ...
            $d='deposit';
            mysqli_query($mysqli,"INSERT INTO `totaltra`(`id`, `tratype`, `amt`) VALUES ('$id','$d','$enamt')");
